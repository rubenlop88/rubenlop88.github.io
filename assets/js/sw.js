...
// 
const SHELL_CACHE = "shell-8.0.0--v1--sw/";
...
const CONTENT_CACHE = "content--2018-08-16T19:04:55-04:00--sw/";
...
// 
// 
const GOOGLE_FONTS = "https://fonts.googleapis.com/css?family=Noto+Serif%7COpen+Sans";
// 

const SHELL_FILES = [
  "/assets/bower_components/fontfaceobserver/fontfaceobserver.standalone.js",
  "/assets/js/hydejack-8.0.0.js",
  "/assets/css/hydejack-8.0.0.css",
...
function isSameSite({ origin, pathname }) {
  return origin.startsWith("https://rubenlop.net") && pathname.startsWith("");
}
